function fig = plot_method_update(Methods, x, classifier_names, classifier_id, method_names, dataset_id, type_accu)
    ...
    for i = 1 : M_cnt
        ...
        semilogy(x, y(1:x_cnt), line_types{1, mod(i, line_types_cnt)+1}, 'LineWidth' , line_width, 'MarkerSize', marker_size, 'Color', C(mod(i, colors_cnt)+1, :));%,'Color', colors(mod(i, colors_cnt)+1, :));
        hold on;
    end
    axis normal;
